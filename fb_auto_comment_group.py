...
GROUP_URL = "https://www.facebook.com/groups/vinfastfadil/"  # <- Thay link nhom cua ban
...
IMAGE_DIR = os.path.join(BASE_DIR, "images", "vinfast")
...
# ============================================================
def comment_first_post_in_group(driver, group_url: str = GROUP_URL, image_dir: str = IMAGE_DIR, prompt_template: str = ""):
    try:
        # 1. Truy cap nhom
        ...
        ai_comment = generate_groq_comment(post_content, prompt_template)
...
def run_group_commenting(
    ...
    for i in range(max_comments):
        ...
        try:
            comment_first_post_in_group(driver, group_url=group_url, image_dir=image_dir, prompt_template=prompt_template)
